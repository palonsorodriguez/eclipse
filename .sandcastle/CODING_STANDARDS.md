Coding standards for this repo. Agents read this file before implementing or
reviewing. Add project-specific rules as they emerge — a documented standard
here always wins over an agent's default instincts.
...
This is an ESM project (`"type": "module"`). Use `import.meta.dirname` and `import.meta.filename` instead of the CJS globals `__dirname` and `__filename`.
